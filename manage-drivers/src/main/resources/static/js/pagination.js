window.sessionStorage;
    ...
    var pager = new Pager('driver-info', PerPagesize);
    pager.init();
...
var pagerName = 'pager';
		...
		document.getElementById("driverDisplayCount").innerText ='Display : '+ $('#driver-info > tr:not([style*="display: none"])').length+" out of " +rowCounter;
